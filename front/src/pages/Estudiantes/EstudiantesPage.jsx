...
import { buscarEstudianteService, modificarEstudianteService, obtenerEstudiantesService } from "../../api/estudiantesAdmService";
          ...
          // if (column.ESTADO === 1) {
              return (
                  <Popconfirm
                      ...
                      onConfirm={() => { showPanelEditEstudiante({ ID: column.ID })}}
                      onCancel={() => ""}
                      okText="Si"
                      cancelText="No"
                  >
  ...
  return (
    <div>
      ...
      <div className="contentDashboard">
        ...
        <Card type="inner" title="Crear estudiantes" initialValues={initialValues}>
        ...
        <Drawer title="Modificar estudiante" placement="right" onClose={hiddenPanelEditEstudiante} open={panelEditarEstudiante}>
                    <Form layout='vertical' form={formModificarEstudiante} onFinish={modificarEstudiante}>
                        <Form.Item label="DNI" name="DNI">
                          <Input />
                        </Form.Item>
