...
import { obtenerProcesosFull, crearProceso, cerrarProceso } from '../../api/apiProcesos'
...
export default function ProcesosPage() {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'FECHA_REGISTRO',
            render: (fecha) => new Date(fecha).toLocaleDateString("es-ES", { day: "2-digit", month: "2-digit", year: "numeric" }).replace(/\//g, "/")
        },
        {
            title: 'Estado',
            dataIndex: 'ESTADO',
            key: 'ESTADO',
            render: (text) => { return text === 0 ? <Tag color="success">Cerrado</Tag> : <Tag color="processing">Abierto</Tag> }
        },
        {
            title: 'Action',
            key: 'action',
                ...
                if (column.ESTADO === 1) {
                    return (
                        <Popconfirm
                            ...
                            cancelText="No"
                        >
                            <Button type="link" danger>Cerrar</Button>
                        </Popconfirm>
                    )
        ...
        <div>
            ...
            <div className='contentDashboard'>
                ...
                <Card type="inner" title="Crear proceso">
                    ...
                    <Form layout='vertical' onFinish={handleSubmit} form={formProceso} initialValues={initialValues}>
                        <div className="formProcesosDashAdmin">
                            <Form.Item label="Nombre del proceso" name="NOMBRE" rules={[{ required: true, message: 'El nombre es requerido' }]} >
                                <Input className='fullSizeInput' placeholder='Ingrese el nombre del proceso' />
                            </Form.Item>
                            <Form.Item label="Fecha de inicio" name="FECHA_REGISTRO" rules={[{ required: true, message: 'La fecha es requerida' }]} >
                                <DatePicker placeholder='Fecha que comienza el proceso' className='fullSizeInput' format="YYYY/MM/DD" />
                            </Form.Item>

                            <Form.Item label="Estado del proceso" name="ESTADO" rules={[{ required: true, message: 'El estado es requerido' }]}>
