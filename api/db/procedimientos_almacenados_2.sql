	  ...
	  DECLARE ubicacion_por_distrito VARCHAR(40);
	   ...
	   -- Insertar datos en la tabla datos_complementarios
		IF datos_complementarios_existente = 0 THEN
			INSERT INTO dat_complementarios (DNI, SEXO, FECHA_NACIMIENTO, LUGAR_RESIDENCIA, DIRECCION, DISCAPACIDAD, TIPO_DISCAPACIDAD, ETNICA, CELULAR, TELEFONO, RUTA_FOTO, NOMBRE_COLEGIO, TIPO_COLEGIO, NOMBRE_COMPLETO_APO, CELULAR_APO, DNI_APO)
			VALUES (DNI, SEXO, FECHA_NACIMIENTO, ubicacion_por_distrito, DIRECCION, DISCAPACIDAD, TIPO_DISCAPACIDAD, ETNICA, CELULAR, TELEFONO, RUTA_FOTO, NOMBRE_COLEGIO, TIPO_COLEGIO, NOMBRE_COMPLETO_APO, CELULAR_APO, DNI_APO);
		ELSE
