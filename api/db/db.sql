...
CREATE TABLE DAT_COMPLEMENTARIOS (
	ID INT PRIMARY KEY AUTO_INCREMENT,
    DNI VARCHAR(8) NOT NULL,
    SEXO CHAR NOT NULL,
    ...
    ETNICA VARCHAR(200) NOT NULL,
    CELULAR VARCHAR(9) NOT NULL,
    TELEFONO VARCHAR(20) NOT NULL,
    RUTA_FOTO VARCHAR(150) NOT NULL,
    NOMBRE_COLEGIO VARCHAR(200) NOT NULL,
    TIPO_COLEGIO CHAR NOT NULL,
    NOMBRE_COMPLETO_APO VARCHAR(200) NOT NULL,
    CELULAR_APO VARCHAR(9) NOT NULL,
    DNI_APO VARCHAR(8) NOT NULL,
    FECHA_REGISTRO DATE NOT NULL,
    CONSTRAINT FK_REGISTROS_DAT_COMPLEMENTARIOS FOREIGN KEY (DNI) REFERENCES REGISTROS(DNI),
    UNIQUE (DNI)
);
...
CREATE TABLE ETNICAS (
    ID INT PRIMARY KEY AUTO_INCREMENT,
    ETNICA VARCHAR(200) NOT NULL
);

CREATE TABLE actitudes (
	ID INT PRIMARY KEY AUTO_INCREMENT,
	DNI VARCHAR(8),
	RESP_1 VARCHAR(20),
	RESP_2 VARCHAR(20),
	...
	TOTAl_2 VARCHAR(5),
	FECHA_REGISTRO DATE,
    CONSTRAINT FK_REGISTROS_ACTITUDES FOREIGN KEY (DNI) REFERENCES REGISTROS(DNI),
    UNIQUE(DNI)
);
