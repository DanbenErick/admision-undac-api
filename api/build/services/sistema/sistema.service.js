    ...
    constructor() {
        ...
        this.loginUsuarioAdmin = (params) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const token = jsonwebtoken_1.default.sign({ id: result[0].ID, usuario: result[0].USUARIO, rol: 'ADMINISTRADOR', dni: result[0].DNI, }, 'UNDAC_ADMISION');
        ...
        this.loginUsuarioEstudiante = (params) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!validarPassword)
                    return { ok: false, message: 'Usuario o contraseña incorrecta' };
                const token = jsonwebtoken_1.default.sign({ id: result[0].ID, rol: 'ESTUDIANTE', dni: result[0].DNI, usuario: result[0].USUARIO }, 'UNDAC_ADMISION');
                return {
                    ok: true,
                    message: 'Se autentico correctamente',
                    name: result[0].NOMBRES || 'USUARIO',
